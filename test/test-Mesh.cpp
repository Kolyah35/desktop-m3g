...
TEST(Mesh_default_variables_1) {
    ...
    int indices[] = {0, 1, 2};
    int strips[] = {3};
    TriangleStripArray* tris[2] = {new TriangleStripArray(3, indices, 1, strips), new TriangleStripArray(3, indices, 1, strips)};
...
TEST(Mesh_setAppearance) {
    ...
    int strips[] = {3};
    TriangleStripArray* tris[2] = {new TriangleStripArray(3, indices, 1, strips), new TriangleStripArray(3, indices, 1, strips)};
    Appearance* apps[2] = {new Appearance, new Appearance};
