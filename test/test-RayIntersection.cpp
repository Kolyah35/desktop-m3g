...
TEST(RayIntersect_set_variable) {
    ...
    int submesh_index = 0;
    RayIntersection ri(mesh, Vector(0, 0, 1), Vector(0, 0, -1), 1, 0.5, 0.5, 3, vertex_indices, submesh_index);
...
TEST(RayIntersection_transformRay) {
    ...
    float v = 0.5;
    int submesh_index = 0;
    RayIntersection ri(node, org, dir, t, u, v, 3, vertex_indices, submesh_index);
