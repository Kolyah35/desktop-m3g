...
TEST(Material_set_variables) {
    ...
    mat->setColor(Material::AMBIENT | Material::DIFFUSE | Material::EMISSIVE | Material::SPECULAR, 0xffffffff);
    CHECK_EQUAL(0x00ffffff, mat->getColor(Material::AMBIENT));
    CHECK_EQUAL(0xffffffff, mat->getColor(Material::DIFFUSE));
    CHECK_EQUAL(0x00ffffff, mat->getColor(Material::EMISSIVE));
    CHECK_EQUAL(0x00ffffff, mat->getColor(Material::SPECULAR));
