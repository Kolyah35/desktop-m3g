...
M3GBackgroundStruct::M3GBackgroundStruct()
    : background_color(0), background_image_index(0), background_image_mode_x(0), background_image_mode_y(0), crop_x(0), crop_y(0), crop_width(0), crop_height(0),
      depth_clear_enabled(false), color_clear_enabled(false) {
    background_color = 0;
...
M3GVertexBufferStruct::M3GVertexBufferStruct()
    : default_color(0), positions_index(0), position_scale(0), normals_index(0), colors_index(0), texcoord_array_count(0), texcoords_index(0), texcoord_scale(0) {
