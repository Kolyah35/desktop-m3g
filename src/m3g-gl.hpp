...
// quick hack
inline static void glOrthof(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble near_val, GLdouble far_val) {
...
// quick hack
inline static void glClearDepth(GLclampf depth) {
    glClearDepthf(depth);
}
    #endif
