...
namespace m3g {
     ...
     */
    m3g::Quaternion squad(const m3g::Quaternion& q0, const m3g::Quaternion& q1, const m3g::Quaternion& q2, const m3g::Quaternion& q3, float t0, float t1, float t2, float t3,
                          float alpha);
