...
namespace m3g {
    ...
    public:
         ...
         */
        SkinnedMesh(VertexBuffer* vertices, int num_submesh, IndexBuffer** submeshes, int num_appearance, Appearance** apperarances, Group* skeleton);
         ...
         * @param[in] skeleton      スケルトン.
         */
        SkinnedMesh(VertexBuffer* vertices, IndexBuffer* submesh, Appearance* apperarance, Group* skeleton);
