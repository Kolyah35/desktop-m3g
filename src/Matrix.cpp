...
Matrix::Matrix(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float m20, float m21, float m22, float m23, float m30, float m31, float m32,
               float m33) {
    m[0] = m00;
    m[1] = m01;
    m[2] = m02;
...
Matrix& Matrix::invert() {
    ...
    float det = +n[0] * n[5] * n[10] * n[15] + n[0] * n[6] * n[11] * n[13] + n[0] * n[7] * n[9] * n[14] + n[1] * n[4] * n[11] * n[14] + n[1] * n[6] * n[8] * n[15] +
                n[1] * n[7] * n[10] * n[12] + n[2] * n[4] * n[9] * n[15] + n[2] * n[5] * n[11] * n[12] + n[2] * n[7] * n[8] * n[13] + n[3] * n[4] * n[10] * n[13] +
                n[3] * n[5] * n[8] * n[14] + n[3] * n[6] * n[9] * n[12] - n[0] * n[5] * n[11] * n[14] - n[0] * n[6] * n[9] * n[15] - n[0] * n[7] * n[10] * n[13] -
                n[1] * n[4] * n[10] * n[15] - n[1] * n[6] * n[11] * n[12] - n[1] * n[7] * n[8] * n[14] - n[2] * n[4] * n[11] * n[13] - n[2] * n[5] * n[8] * n[15] -
                n[2] * n[7] * n[9] * n[12] - n[3] * n[4] * n[9] * n[14] - n[3] * n[5] * n[10] * n[12] - n[3] * n[6] * n[8] * n[13];
