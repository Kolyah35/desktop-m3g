...
PolygonMode::PolygonMode()
    : culling(CULL_BACK), winding(WINDING_CCW), shading(SHADE_SMOOTH), two_sided_lighting(false), local_camera_lighting(true), perspective_correction(true) {}
...
static const char* culling_to_string(int culling) {
    switch (culling) {
...
static const char* winding_to_string(int winding) {
    switch (winding) {
...
static const char* shading_to_string(int shading) {
    switch (shading) {
