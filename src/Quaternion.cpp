...
Quaternion::Quaternion(float angle, float ax, float ay, float az) : x(0), y(0), z(0), w(1) {
    if (angle < 0 || angle > 0) {
 ...
 */
m3g::Quaternion m3g::squad(const m3g::Quaternion& q0, const m3g::Quaternion& q1, const m3g::Quaternion& q2, const m3g::Quaternion& q3, float t0, float t1, float t2, float t3,
                           float s) {
