...
namespace m3g {
    ...
    public:
         ...
         * @~Japanese
         */
        void setMorphing(const VertexArray* base_positions, const std::vector<const VertexArray*>& morph_target_positions, const std::vector<float>& morph_wegiths);
         ...
         * @~Japanese
         */
        void setSkinning(const VertexArray* base_positions, const std::vector<std::vector<BoneWeight>>& bone_indices, const std::vector<Matrix>& matrix_palette);
