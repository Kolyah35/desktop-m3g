...
Light::Light() : mode(DIRECTIONAL), color(0x00ffffff), intensity(1), attenuation(1, 0, 0), spot(45, 0) {}
...
void Light::addAnimationTrack_xxx(AnimationTrack* animation_track, bool accepted) {
    ...
    if (property == AnimationTrack::COLOR || property == AnimationTrack::INTENSITY || property == AnimationTrack::SPOT_ANGLE || property == AnimationTrack::SPOT_EXPONENT) {
        accepted = true;
    }
