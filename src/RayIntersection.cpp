...
RayIntersection::RayIntersection() : ray(Vector(0, 0, 0), Vector(0, 0, 1), 0), node(0), u(0), v(0), submesh_index(0), normal(0) {
...
RayIntersection::RayIntersection(Node* node_, const Vector& org, const Vector& dir, float t, float u_, float v_, int vertex_num, int* vertex_indices, int submesh_index_)
    : ray(Vector(0, 0, 0), Vector(0, 0, 1), 0), node(0), u(0), v(0), submesh_index(0), normal(0) {
    ray.org = org;
    ray.dir = dir;
    ray.t = t;
    node = node_;
